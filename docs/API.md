...
```json
{
  "mnemonic": "baudrier obscur symétrie broder animal mythique nappe détacher sorcier capuche écluse puiser éclore jaguar agile",
  "passphrase": "hello",
  "wordList": "French",
  "wordCount": 15,
  "masterHDFingerprint": "af6279f5",
  "masterHDKey": "tprv8ZgxMBicQKsPdWHshCceiD9MnVzEzaLfiHzmmmRXGhvMToUp6zR8MrxGkZqhHX98JS28cwdW8hqE2PQkuWDkBTsUPGgEDNwYSofeFZF7zyu",
  "accountHDKey": "tprv8h6WMW3MTtXCxBeViecCpbnpy1WzNVroYcLV8ejJLy1cVyVZgb3TVJWTxSXmJBcgChtQfMgSVaSfp7Ph7xLaZtj6mWpfNeKvWD9t7QiTnTb",
  "accountKeyPath": "49'/1'/2'",
  "derivationScheme": "tpubDDnYVv5bcGCsqegHcJGoE1SwY32vXq3i7uwGRAmbmEp1LTkLJys3fo8L8a1bzSpnBx8mNs1kwNtPMByokeZdP65yoKmin3RgXcGAb4P6n7q-[p2sh]"
}
```
...
* `masterHDFingerprint`: The [BIP174](https://github.com/bitcoin/bips/blob/master/bip-0174.mediawiki) master key fingerprint.
...
* `AccountKeyPath`: The `accountKeyPath` to this `AccountHDKey`
