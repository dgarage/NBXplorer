...
namespace NBXplorer.Configuration
{
    public class DefaultConfiguration : StandardConfiguration.DefaultConfiguration
    {
        protected override CommandLineApplication CreateCommandLineApplicationCore()
        {
            ...
            app.Option("--AWSSQSBlockQueueURL", "[For AWS SQS] SQS Queue URLs to push new block message to. Leave blank to turn off", CommandOptionType.SingleValue);
            app.Option("--AWSSQSTransactionQueueURL", "[For AWS SQS] SQS Queue URLs to push new transaction message to. Leave blank to turn off", CommandOptionType.SingleValue);
        ...
        protected override string GetDefaultConfigurationFileTemplate(IConfiguration conf)
        {
            ...
            builder.AppendLine("####AWS SQS####");
            builder.AppendLine("## AWS SQS configuration - Set Queue URLS to publish message to queues");
            builder.AppendLine("#AWSSQSBlockQueueURL=<new block queue URL>");
            builder.AppendLine("#AWSSQSTransactionQueueURL=<new transaction queue URL>");
