...
namespace NBXplorer.Configuration
{
    ...
    public class ExplorerConfiguration
    {
        ...
        public ExplorerConfiguration LoadArgs(IConfiguration config)
        {
            ...
            AWSSQSTransactionQueueURL = config.GetOrDefault<string>("AWSSQSTransactionQueueURL", "");
            AWSSQSBlockQueueURL = config.GetOrDefault<string>("AWSSQSBlockQueueURL", "");
        ...
        public string AWSSQSTransactionQueueURL
        {
            get;
            set;
        }

        public string AWSSQSBlockQueueURL
        {
            get;
            set;
        }
