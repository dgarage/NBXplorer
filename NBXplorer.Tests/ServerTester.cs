    ...
    public partial class ServerTester : IDisposable
    {
        ...
        public ServerTester(string directory)
        {
            ...
            try
            {
                ...
                keyValues.Add(("AWSSQSBlockQueueURL", AWSSQSTestConfig.AWSSQSBlockQueueURL));
                keyValues.Add(("AWSSQSTransactionQueueURL", AWSSQSTestConfig.AWSSQSTransactionQueueURL));
