...
namespace NBXplorer.Tests
{
	public class UnitTest1
	{
		...
		[InlineData(true)]
		[InlineData(false)]
		public async void ShowRBFedTransaction3(bool cancelB)
		{
...
#pragma warning restore CS0618 // Type or member is obsolete
				...
				tester.Client.Wipe(pubkey);
				using var conn = await tester.GetService<DbConnectionFactory>().CreateConnection();
